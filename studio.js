import { Motion, PARAMS, clamp } from './engine/motion.js?v=0.4.6';
import { buildScene, fitView, editPartRect } from './engine/geometry.js?v=0.4.6';
import { WebGLRenderer, CanvasRenderer, loadTextures, drawMesh } from './engine/renderer.js?v=0.4.6';
import { VoicePlayer } from './engine/audio.js?v=0.4.6';
...
async function start() {
  const rigURL = new URL('character/glitch/rig.json?v=0.4.6', location.href);
