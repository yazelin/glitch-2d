import { Motion, PARAMS, clamp } from './engine/motion.js?v=0.4.4';
import { buildScene, fitView, editPartRect } from './engine/geometry.js?v=0.4.4';
import { WebGLRenderer, CanvasRenderer, loadTextures, drawMesh } from './engine/renderer.js?v=0.4.4';
import { VoicePlayer } from './engine/audio.js?v=0.4.4';
...
async function start() {
  const rigURL = new URL('character/glitch/rig.json?v=0.4.4', location.href);
