...
try{
 ...
 await page.getByRole('slider',{name:'頭部傾斜',exact:true}).fill('30');await page.waitForTimeout(150);assert.equal(await page.evaluate(()=>window.__rig.core.getParameterValueById('ParamAngleZ')),30);
